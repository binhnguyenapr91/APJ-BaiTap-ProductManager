...
public class MainView {
	...
	public Product createProductForm() throws NumberFormatException, IOException {
		...
		//DAO.writeToFile(newProduct, "files\\productData.dat");
		
//		ProductView productView= new ProductView();
//		ProductController productController = new  ProductController(newProduct,productView);
...
//		productController.updateProductView();
	...
	public static void displayAllProducts(ArrayList<Product> productList) {
		System.out.println("================DISPLAY ALL PRODUCTS======================================");
		System.out.printf("%-5s%-20s%-20s%-10s%-30s\n","id","name","manufacturer","price","information");
		Iterator<Product> itr = productList.iterator();
		while(itr.hasNext()) {
			Product holder = itr.next();
			System.out.printf("%-5s%-20s%-20s%-10s%-30s\n",holder.getId(),holder.getName(),holder.getManufacturer(),holder.getPrice(),holder.getInformation());
		}
		System.out.println("===========================================================================");
